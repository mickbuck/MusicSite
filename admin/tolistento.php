...
include("../include/config.php"); {
    $q = "SELECT * from artist WHERE tolistento = '1' AND (rating is NULL OR rating = '' OR rating = '0') order by listenorder desc, artist.name desc, UPPER(LTRIM(Replace(artist.name, 'The ', '')));";

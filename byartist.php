...
include("include/config.php"); {
    $id = ($_GET["id"]);
    $q = "SELECT * FROM album Where artist_id = $id AND (wanted IS NULL OR wanted != '1') AND album.format > '0' AND album.sold NOT LIKE '1' order by UPPER(LTRIM(Replace(name, 'The ', '')));";
